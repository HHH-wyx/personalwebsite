...
import { locales, Locale } from '../../public/locales';
...
const ThemeSwitcher = () => {
  ...
  React.useEffect(() => {
    ...
    // 设置文字颜色为黑色 - 直接应用到所有文本元素
    root.style.color = '#000000'; // 纯黑色
    body.style.color = '#000000'; // 纯黑色
    
    // 更新所有文本元素的颜色
    const allTextElements = document.querySelectorAll('h1, h2, h3, h4, h5, h6, p, span, a, li, button');
    allTextElements.forEach(element => {
      element.style.color = '#000000'; // 所有文本元素都设置为纯黑色
    });
    ...
    cards.forEach(card => {
      ...
      card.style.color = '#000000'; // 卡片内文字纯黑色
...
const HomeContent = ({ lang }: { lang: string }) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      {/* 页脚 */}
      <footer className="py-8 dark:bg-gray-800 text-center">
        <div className="container mx-auto px-4">
